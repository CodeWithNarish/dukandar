...
const SettingsModelSchema = CollectionSchema(
  ...
  id: 4013777327486952960,
  properties: {
    r'autoSaveHistory': PropertySchema(
      id: 0,
      name: r'autoSaveHistory',
      type: IsarType.bool,
    ),
...
void _settingsModelSerialize(
  ...
  writer.writeBool(offsets[0], object.autoSaveHistory);
...
SettingsModel _settingsModelDeserialize(
  ...
  object.autoSaveHistory = reader.readBool(offsets[0]);
  object.id = id;
...
extension SettingsModelQueryFilter
  ...
  QueryBuilder<SettingsModel, SettingsModel, QAfterFilterCondition>
      autoSaveHistoryEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'autoSaveHistory',
        value: value,
      ));
    });
  }
...
extension SettingsModelQuerySortBy
  ...
  QueryBuilder<SettingsModel, SettingsModel, QAfterSortBy>
      sortByAutoSaveHistory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'autoSaveHistory', Sort.asc);
    });
  }

  QueryBuilder<SettingsModel, SettingsModel, QAfterSortBy>
      sortByAutoSaveHistoryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'autoSaveHistory', Sort.desc);
    });
  }
...
extension SettingsModelQueryWhereDistinct
  ...
  QueryBuilder<SettingsModel, SettingsModel, QDistinct>
      distinctByAutoSaveHistory() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'autoSaveHistory');
    });
  }
...
extension SettingsModelQueryProperty
  ...
  QueryBuilder<SettingsModel, bool, QQueryOperations>
      autoSaveHistoryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'autoSaveHistory');
    });
  }
